        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/refresh-token").permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/play-areas").permitAll()
                    .requestMatchers("/api/play-areas/**").hasAnyRole("ADMIN", "STAFF")
                    .requestMatchers(HttpMethod.GET, "/api/combos").permitAll()
                    .requestMatchers("/api/combos/**").hasAnyRole("ADMIN", "STAFF")
